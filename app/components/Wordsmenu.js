    ...
    return (
      ...
      <ImageBackground source={require('./app/assets/images/background/bg4.jpg')} style={styles.bg}>
       ...
       >
          ...
          source={require('./app/assets/images/buttons/vowels.png')}
            />
            </TouchableOpacity>                         
        </View>
          </View>
       ...
       >
            <Image style={styles.level}
          source={require('./app/assets/images/buttons/consonants.png')}
            />
          </TouchableOpacity>
       ...
       >
            <Image style={styles.level}
          source={require('./app/assets/images/buttons/vowelsandcon.png')}
            />
          </TouchableOpacity>
